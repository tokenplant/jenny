...
// uuidV4Re matches a lowercase UUID v4 (variant-1) string. It enforces
// the version digit "4" in the 13th nibble and the variant nibble
// being 8/9/a/b, exactly as generated by crypto/rand-based UUID v4
// routines used elsewhere in jenny.
var uuidV4Re = regexp.MustCompile(
	`^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$`,
)

func isValidUUID(s string) bool { return uuidV4Re.MatchString(s) }
